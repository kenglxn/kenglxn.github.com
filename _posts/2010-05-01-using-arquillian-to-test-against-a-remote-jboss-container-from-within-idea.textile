...
!/attachments/arquillian-greentestrun-300x140.png!:/attachments/arquillian-greentestrun.png

And that the server has the expected output in the log:

!/attachments/arquillian-serverlog-300x150.png!:/attachments/arquillian-serverlog.png

Just for kicks, let's break the test by changing the input to "yo":

!/attachments/arquillian-redtestrun-300x146.png!:/attachments/arquillian-redtestrun.png
