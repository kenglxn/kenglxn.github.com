...
Just extract "jSudokuSolver.zip":http://www.glxn.net/wp-content/uploads/2010/04/jSudokuSolver.zip and run:
...
Heres the sample:
!/attachments/sample2-150x150.png!:/attachments/sample2.png

And here's the sample solved:
!/attachments/sample-solved-150x150.png!:/attachments/sample-solved.png
