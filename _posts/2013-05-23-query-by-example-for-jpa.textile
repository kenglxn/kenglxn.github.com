...
example = query.by(entityManager)
{% endhighlight %}

And then you have a "QBEExample":https://github.com/kenglxn/QueryByExample/blob/master/src/main/java/net/glxn/qbe/QBEExample.java
{% highlight java %}
