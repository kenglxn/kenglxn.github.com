...
* This has been proven to be true with the "protostuff maven plugin":https://code.google.com/p/protostuff/
in these cases it would be better if mvnr did a cd to the pom.xml  path, but I have decided not to do it like this, as -f really should be respected.
